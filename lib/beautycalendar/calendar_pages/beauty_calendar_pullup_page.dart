...
import 'package:rili/beautycalendar/calendar_widgets/calendar_float_action_button.dart';
import 'package:rili/beautycalendar/calendar_widgets/clock_off/clock_both_side_widget.dart';
import 'package:rili/beautycalendar/calendar_widgets/clock_off/clock_selected_day_widget.dart';
...
class BeautyCalendarPullUpPage extends StatefulWidget {
  final BeautyCalendarConfig _config;
  final OnSelectedEvent onSelected;

  BeautyCalendarPullUpPage(this._config, this.onSelected);

  @override
  _BeautyCalendarPullUpPageState createState() => _BeautyCalendarPullUpPageState();
}

class _BeautyCalendarPullUpPageState extends State<BeautyCalendarPullUpPage> {
